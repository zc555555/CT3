...
builtin.module {
  "choco_ast.program"() ({
    ...
    "choco_ast.assign"() ({
      ...
      "choco_ast.id_expr"() <{"id" = "j"}> : () -> ()
    }) : () -> ()
    "choco_ast.assign"() ({
      "choco_ast.id_expr"() <{"id" = "i"}> : () -> ()
    }, {
      "choco_ast.id_expr"() <{"id" = "k"}> : () -> ()
    }) : () -> ()
  }) : () -> ()
}
...
// CHECK-NEXT:     }) : () -> ()
// CHECK-NEXT:     "choco_ast.var_def"() ({
// CHECK-NEXT:       "choco_ast.typed_var"() <{"var_name" = "k"}> ({
// CHECK-NEXT:         "choco_ast.list_type"() ({
// CHECK-NEXT:           "choco_ast.list_type"() ({
// CHECK-NEXT:             "choco_ast.type_name"() <{"type_name" = "int"}> : () -> ()
// CHECK-NEXT:           }) : () -> ()
...
// CHECK-NEXT:     }, {
// CHECK-NEXT:       "choco_ast.id_expr"() <{"id" = "j", "type_hint" = !choco_ir.list_type<!choco_ir.named_type<"int">>}> : () -> ()
// CHECK-NEXT:     }) : () -> ()
// CHECK-NEXT:     "choco_ast.assign"() ({
// CHECK-NEXT:       "choco_ast.id_expr"() <{"id" = "i", "type_hint" = !choco_ir.named_type<"object">}> : () -> ()
// CHECK-NEXT:     }, {
// CHECK-NEXT:       "choco_ast.id_expr"() <{"id" = "k", "type_hint" = !choco_ir.list_type<!choco_ir.list_type<!choco_ir.named_type<"int">>>}> : () -> ()
// CHECK-NEXT:     }) : () -> ()
// CHECK-NEXT:   }) : () -> ()
// CHECK-NEXT: }
